...
checkRequest(req, fn) {
  ...
  if (origin) {
    try {
      ...
      let defaultPort = 'https:' == parts.protocol ? 443 : 80;
...
attach(srv, opts) {
  if ('function' == typeof srv) {
    let msg = 'You are trying to attach socket.io to an express ' +
...
attachServe(srv) {
  ...
  let url = this._path + '/socket.io.js';
